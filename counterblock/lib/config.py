...
QUOTE_ASSETS = ['BTC', 'XBTC', 'XCP', 'BITCRYSTALS'] # define the priority for quote asset
MARKET_LIST_QUOTE_ASSETS = ['XCP', 'BITCRYSTALS', 'XBTC', 'BTC'] # define the order in the market list
